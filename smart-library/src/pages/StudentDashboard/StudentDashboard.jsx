  ...
  return (
    <div className="StudentDashboard">
      ...
      <div className="StudentDashboard-main">
        ...
        {/* Recommended Books Section */}
        <div className="StudentDashboard-recommended">
          <div className="StudentDashboard-section-header">
            <h2 className="StudentDashboard-recommended-title">Recommended Books</h2>
            <span 
              className="StudentDashboard-see-more" 
              onClick={() => navigate('/student-recommended-books')}
            >
              See more
            </span>
          </div>
        ...
        <div className="StudentDashboard-recent">
          <div className="StudentDashboard-section-header">
            ...
            <span 
              className="StudentDashboard-see-more" 
              onClick={() => navigate('/student-recent-reads')}
            >
              See more
            </span>
          </div>
        ...
        <div className="StudentDashboard-academicbook">
          <div className="StudentDashboard-section-header">
            ...
            <span 
              className="StudentDashboard-see-more" 
              onClick={() => navigate('/student-academic-books')}
            >
              See more
            </span>
          </div>
        ...
        <div className="StudentDashboard-nonacademicbook">
          <div className="StudentDashboard-section-header">
            ...
            <span 
              className="StudentDashboard-see-more" 
              onClick={() => navigate('/student-nonacademic-books')}
            >
              See more
            </span>
          </div>
